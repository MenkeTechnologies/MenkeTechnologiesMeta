...
# our own ecosystem.
core_allowlist="jq pnpm tmux zsh node python3 git rustup ripgrep fd bat eza go cmake protobuf libpcap pkg-config openssl libsodium gh redis mongodb-community apache-spark librdkafka ccze tesseract geckodriver selenium-server"
