...
| [`app-store`](https://github.com/MenkeTechnologies/app-store) | **Static storefront** (HTML/CSS/JS) for the MenkeTechnologies audio products — `Audio-Haxor`, `traderview`, `zpwr-synth`, `zpwr-fx`. Shares the strykelang-docs HUD/cyberpunk design system (`hud-static.css`, `tutorial.css`, `hud-theme.js`); no build step. &middot; <sub>[docs](https://menketechnologies.github.io/MenkeTechnologiesMeta/app-store) · [report](https://menketechnologies.github.io/MenkeTechnologiesMeta/app-store/report)</sub> |
