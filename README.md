...
[![Submodules](https://img.shields.io/badge/submodules-124-blue.svg)](#0x01-submodule-map)
[![Tier 1](https://img.shields.io/badge/tier_1-35_core-cyan.svg)](#tier-1--core-35)
...
The `--recurse-submodules` flag fetches all 124 submodules in parallel during the initial clone.
...
All 124 submodules sit flat at the repository root. URLs are HTTPS for fresh-host portability (no SSH key needed for `clone --recurse`).
