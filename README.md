...
[![Submodules](https://img.shields.io/badge/submodules-120-blue.svg)](#0x01-submodule-map)
[![Tier 1](https://img.shields.io/badge/tier_1-31_core-cyan.svg)](#tier-1--core-31)
...
The `--recurse-submodules` flag fetches all 120 submodules in parallel during the initial clone.
...
All 120 submodules sit flat at the repository root. URLs are HTTPS for fresh-host portability (no SSH key needed for `clone --recurse`).
