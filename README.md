...
[![Submodules](https://img.shields.io/badge/submodules-125-blue.svg)](#0x01-submodule-map)
...
The `--recurse-submodules` flag fetches all 125 submodules in parallel during the initial clone.
...
All 125 submodules sit flat at the repository root. URLs are HTTPS for fresh-host portability (no SSH key needed for `clone --recurse`).
