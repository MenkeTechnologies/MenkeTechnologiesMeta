...
| [`stryke-fleet`](https://github.com/MenkeTechnologies/stryke-fleet) | Fleet orchestration for distributed stryke agents/controllers. |
...
| [`stryke-mcpd`](https://github.com/MenkeTechnologies/stryke-mcpd) | MCP (Model Context Protocol) daemon. |
