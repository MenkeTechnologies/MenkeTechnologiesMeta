...
[![Submodules](https://img.shields.io/badge/submodules-73-blue.svg)](#0x01-submodule-map)
...
### `[META REPO // 73 SUBMODULES // ONE COMMAND, EVERY MENKETECHNOLOGIES PROJECT]`
...
| 2 — Stryke ecosystem | [`stryke-azure`](https://github.com/MenkeTechnologies/stryke-azure) | — | — | [![Version](https://img.shields.io/github/v/tag/MenkeTechnologies/stryke-azure?sort=semver&label=&color=blue)](https://github.com/MenkeTechnologies/stryke-azure/tags) |
